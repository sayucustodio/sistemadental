			...
			case 'string':
				if(source.length) {
					loader = function() {
						...
						var d_medico = self.options.medico;
						var d_especialidad = self.options.especialidad;
						var d_estado = self.options.estado;
						var params = {estado:d_estado,medico:d_medico,especialidad:d_especialidad,from: d_from.getTime(), to: d_to.getTime(), utc_offset_from: d_from.getTimezoneOffset(), utc_offset_to: d_to.getTimezoneOffset()};
