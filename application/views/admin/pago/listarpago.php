    ...
    <div class="row">
      <div class="col-md-12">
        <div class="box box-info">
                 ...
                 <ol class="breadcrumb">
                    <li><a href="<?= base_url('mantenimiento/pago') ?>"><i class="fa fa-refresh"></i> Actualizar</a></li>
                    <li><a href="<?= base_url('mantenimiento/pago/nuevo') ?>"><i class="fa fa-user-plus"></i> Nuevo</a></li>
          ...
          <div class="box-body pad">
            <form id="PagoFormBusqueda" autocomplete="off">
                      <div class="row">
              ...
              <div class="col-md-4">
                <div class="form-group">
                  ...
                  <input type="text" name="tipo_pago" class="form-control input-sm">
                </div>
              </div>
        ...
        <div class="box">
          <div class="box-header">
              ...
              <div class="table-responsive">
                <table id="TableMantenimientoPago" class="table table-bordered table-striped table-sm">
                  <thead>
                    <tr class="info">
