      ...
      <div class="row">
        <div class="col-md-12">
          <div class="box box-info">
                   ...
                   <ol class="breadcrumb">
                      <li><a href="<?= base_url('mantenimiento/diagnostico') ?>"><i class="fa fa-refresh"></i> Actualizar</a></li>
                      <li><a href="<?= base_url('mantenimiento/diagnostico/nuevo') ?>"><i class="fa fa-user-plus"></i> Nuevo</a></li>
            ...
            <div class="box-body pad">
              <form id="DiagnosticoFormBusqueda" autocomplete="off">
                        <div class="row">
                ...
                <div class="col-md-4">
                  <div class="form-group">
                    ...
                    <input type="text" name="enfermedad" class="form-control input-sm">
                  </div>
                </div>
