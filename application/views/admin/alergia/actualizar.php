    ...
    <div class="row">
      <div class="col-md-12">
        ...
        <div class="box-body pad">
                  ...
                  <form  id="FormRegistrarBanco" action="<?php echo base_url();?>mantenimiento/alergia/update" method="POST" autocomplete="off">
          ...
          <div class="row">
                  ...
                  <div class="form-group">
                    <label class="control-label">Secuencia</label>
                        <input type="text" class="form-control input-sm" name="codigo" value="<?php echo $alergia->cod_ale;?>" readonly="readonly">
                  </div>
                </div>
                ...
                <div class="col-md-8">
                  <div class="form-group">
                    ...
                    set_value('nombre'):$alergia->nombre_ale?>">
                  </div>
                </div>
