    ...
    <div class="row">
      <div class="col-md-12">
        <div class="box box-info">
                 ...
                 <ol class="breadcrumb">
                    <li><a href="<?= base_url('mantenimiento/moneda') ?>"><i class="fa fa-refresh"></i> Actualizar</a></li>
                    <li><a href="<?= base_url('mantenimiento/moneda/nuevo') ?>"><i class="fa fa-user-plus"></i> Nuevo</a></li>
            ...
            <form id="MonedaFormBusqueda" autocomplete="off">
              ...
              <div class="col-md-4">
                <div class="form-group">
                  <label class="control-label">Busqueda por moneda :</label>
                  <input type="text" name="tipo_moneda" class="form-control input-sm">
                </div>
              </div>
        ...
        <div class="box">
          <div class="box-header">
              ...
              <div class="table-responsive">
                <table id="TableMantenimientoMoneda" class="table table-bordered table-striped table-sm">
                  <thead>
                    <tr class="info">
