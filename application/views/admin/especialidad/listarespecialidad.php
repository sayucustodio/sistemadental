...
<div class="content-wrapper">
  ...
  <section class="content-header">
    <h1>
     <i class="fa fa-th-list" aria-hidden="true"></i>  Especialidad
    </h1>
    <ol class="breadcrumb">
    ...
    <div class="row">
      <div class="col-md-12">
        <div class="box box-info">
                 ...
                 <ol class="breadcrumb">
                    <li><a href="<?= base_url('mantenimiento/especialidad') ?>"><i class="fa fa-refresh"></i> Actualizar</a></li>
                    <li><a href="<?= base_url('mantenimiento/especialidad/nuevo') ?>"><i class="fa fa-user-plus"></i> Nuevo</a></li>
          ...
          <div class="box-body pad">
            <form id="EspecialidadFormBusqueda" autocomplete="off">
                      <div class="row">
          
            
              <div class="col-md-4">
                <div class="form-group">
                  <label class="control-label">Busqueda por especialidad :</label>
                  <input type="text" name="especialidad" class="form-control input-sm">
                </div>
              </div>
        ...
        <div class="box">
          <div class="box-header">
              ...
              <div class="table-responsive">
                <table id="TableMantenimientoEspecialidad" class="table table-bordered table-striped table-sm">
                  <thead>
                    <tr class="info">
