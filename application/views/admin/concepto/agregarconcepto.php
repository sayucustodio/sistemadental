      ...
      <div class="row">
        <div class="col-md-12">
          ...
          <div class="box-body pad">
              ...
              <form id="FormRegistrarConcepto" action="<?php echo base_url();?>mantenimiento/concepto/guardar" method="POST" autocomplete="off">
            ...
            <div class="row">
                  ...
                  <div class="col-md-8">
                    <div class="form-group <?php echo !empty(form_error('concepto'))? 'has-error':'';?>">
                      ...
                      <input type="text" name="concepto" class="form-control input-sm" placeholder="Nombre">
                    </div>
                  </div>
