    ...
    <div class="panel-body">
        <ul class="nav nav-tabs" role="tablist" style="margin-bottom: 15px">
            <li class="active" role="presentation"><a href="#registrar" aria-controls="registrar" role="tab"
                    data-toggle="tab">Registrar</a></li>
        ...
        <div class="tab-content">
            <div role="tabpanel" class="tab-pane active" id="registrar">
                ...
                <form id="FormHistoriaMovimientoPacienteReceta"
                    action="<?= base_url('historia/movimiento/guardarReceta') ?>" method="post">
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="medico" class="form-control input-sm"
                                            value="<?= $this->session->userdata('codi_usu') ?>" readonly>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <select name="asunto" class="form-control">
                                            ...
                                            <?php foreach ($diagnostico_paciente as $a): ?>
                                            <option value="<?= $a->codi_enf01 ?>"><?= $a->codi_enf01 ?></option>
                                            <?php endforeach ?>
                                        </select>
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <button type="button" class="btn btn-success btn-sm" data-toggle="modal"
                                            data-target="#ModalAgregarReceta"><i class="fa fa-plus"
                                    ...
                                    <table id="TableHistoriaMovimientoRecetas" class="table table-bordered">
                                        <thead>
                                            <tr class="btn-primary btn-xs">
                                                ...
                                                <th style="text-align: center;">Forma farmaceútica</th>
                                                <th style="text-align: center;">Cantidad</th>
                                                <th style="text-align: center;">Vía de tratamiento</th>
                                                <th style="text-align: center;">Indicaciones</th>
                                                <th style="text-align: center;">Opciones</th>
                                            </tr>
                                        </thead>
                                        <tbody id="TratamientoBodyMedicamento">
